...
public class Instatiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("20/08/2019"), "Partiu Viagem", "Vou viajar pra Sampa, abraços!", maria);
		Post post2 = new Post(null, sdf.parse("21/08/2019"), "Cheguei", "Sampa, cheguei!", maria);
